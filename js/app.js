...
function screenAbout(){
  ...
  h += '<div class="landhero">' +
    '<div class="landkick">информатика · 5–11 класс</div>' +
  ...
  var nums = [
    ...
    [c.algo,     plural(c.algo,     "задача", "задачи", "задач"),          "алгоритмы и формат ОГЭ и ЕГЭ"],
  ...
  h += '<div class="landsect"><h2>Кроме уроков</h2>' +
    '<p class="lede">Сюда заходят между уроками, по настроению. Звёзд тут не дают ' +
    'и по порядку проходить не надо.</p><div class="landgrid">';
  trainCards().forEach(function(t){
