...
function screenAbout(){
  ...
  h += '<div class="landsect"><h2>Как проходит урок</h2>' +
    ...
    '<ol class="landsteps">' +
    '<li><b>Читаешь объяснение</b><span>Короткая теория, а к ней живые примеры: ' +
      'у каждого кнопка «▶ Запустить пример» — код срабатывает тут же, на месте.</span></li>' +
    ...
    '<li><b>Жмёшь «✓ Проверить»</b><span>Не сошлось — тренажёр покажет, чем твой ответ ' +
      'отличается от нужного. Подсказки идут по шагам: от намёка к ответу, а не сразу решение.</span></li>' +
    '</ol>' +
    '<div class="note"><b>Ошибка здесь — не ругань</b>Красный текст Python переведён на русский: ' +
    'написано, в какой строке и что именно не сошлось. А если код работает не так, как думал, — ' +
    'визуализатор пройдёт программу по шагам и покажет, что лежит в памяти.</div></div>';

  /* --- направления. Отдельным разделом, а не карточкой в общей сетке.
         Жалоба фаундера 06.09.2026: «мы же сделали и другие направления, и
         ЕГЭ» — и он прав: экзамены, ИИ и проекты стояли одной строкой среди
  ...
  /* --- что остаётся на руках. Раздел заведён по прямому указанию фаундера
         06.09.2026 («не пропусти часть нашей работы»): портфолио, сертификаты,
  ...
  h += '<div class="landsect"><h2>Что остаётся на руках</h2>' +
    ...
    '<div class="landcard"><span class="lcem">🖼</span><b>Рисунки и файлы .py</b>' +
      '<p>Что нарисовала черепашка — уезжает в галерею. Любую свою программу можно ' +
      'выгрузить настоящим файлом .py и открыть во взрослом Python.</p></div>' +
    '<div class="landcard"><span class="lcem">✍️</span><b>Своё задание</b>' +
      '<p>Ребёнок сам придумывает задачу, движок считает по ней правильный ответ, ' +
      'а задание уезжает ссылкой другу — или взрослому: пусть теперь он решает.</p></div>' +
    '<div class="landcard"><span class="lcem">🎮</span><b>Своя игра по ссылке</b>' +
      '<p>Собранную игру отправляют одной ссылкой. Тот, кому её прислали, играет ' +
      'сразу в браузере и может заглянуть в код — ничего не устанавливая.</p></div>' +
    '<div class="landcard"><span class="lcem">🧰</span><b>Мастерская</b>' +
      '<p>Куски своих программ складываются на полку деталей, а на верстаке из них ' +
      'собирается новая — своя, а не по заданию.</p></div>' +
    '<div class="landcard"><span class="lcem">🔁</span><b>Повторить</b>' +
      '<p>Уроки, которые дались тяжело, возвращаются сами через несколько дней. ' +
      'Рядом — бестиарий: каждая ошибка, которую ребёнок победил, с её именем.</p></div>' +
    '</div></div>';
  ...
  h += '<div class="landsect"><h2>Взрослому: родителю, учителю, репетитору</h2>' +
    ...
    '<div class="landcard"><span class="lcem">📊</span><b>Отчёт за неделю</b>' +
      '<p>Сколько времени, какие уроки, где застрял. Точное время, а не «занимался/не занимался».</p></div>' +
    '<div class="landcard"><span class="lcem">📝</span><b>Домашка</b>' +
      '<p>Можно выбрать задачи и отдать их ребёнку — он увидит их на Главном рядом с «Продолжить».</p></div>' +
    '<div class="landcard"><span class="lcem">⏱</span><b>Потолок экранного времени</b>' +
      '<p>Сколько минут в день. По умолчанию тренажёр только напоминает; жёсткий запрет включается отдельно ' +
      'и никогда не обрывает начатый урок.</p></div>' +
    '<div class="landcard"><span class="lcem">🖼</span><b>Витрина работ</b>' +
      '<p>Что ребёнок собрал своими руками: программы, рисунки, проекты. Их можно запустить и показать.</p></div>' +
    '<div class="landcard"><span class="lcem">🔗</span><b>Код ученика</b>' +
      '<p>По нему прогресс виден на другом устройстве и в кабинете. Один код — один ребёнок.</p></div>' +
    '</div></div>';
  ...
  h += '<div class="landsect"><h2>Честно про границы</h2>' +
    ...
    '<li><b>Экзамены закрываем не целиком.</b> Мы берём ту часть ОГЭ и ЕГЭ, где надо ' +
      'написать программу, и алгоритмику. Кодирование информации, таблицы и работа с файлами ' +
      'сюда не входят.</li>' +
    '<li><b>Проверяет программа, а не человек.</b> Живого учителя, разбора кода взрослым ' +
      'и оценок тут нет: решение сверяет движок, а объясняет — сам урок.</li>' +
    '<li><b>Прогресс лежит в браузере.</b> На этом устройстве он никуда не уходит и работает ' +
      'без сети. Чтобы он был виден на втором устройстве и в кабинете взрослого, нужен код ученика.</li>' +
    '</ul></div>';
