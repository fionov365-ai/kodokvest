...
function screenAlgo(){
  ...
  var h = '<div class="lvlhead"><div><div class="idx">информатика: алгоритмы и экзамен</div>' +
    ...
    'сортировка, цена алгоритма, кодирование информации, логика, графы и типовые задания ' +
    'экзамена. Заходить можно с любого места курса — всё, что нужно, объясняется прямо ' +
    'в задании.</p>';
  ...
  h += '<div class="card"><h3>⚖️ Что мы обещаем, а что нет</h3><ul class="trrules">' +
    ...
    '<li><b>Не закрываем экзамен целиком.</b> С 1.77.0 добавлены кодирование информации, ' +
    'логика и графы — их тут решают программой, и наш судья их проверяет. Чего по-прежнему нет: ' +
    '<b>электронные таблицы</b>. Их проверять нечем — движок умеет запускать Python, а не считать ' +
    'формулы Excel.</li>' +
