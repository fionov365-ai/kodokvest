/* ============================================================
   Фионика — экран «Витрина: что создают ученики».
...
function screenShowcase(){
  ...
  /* ⚠️ Число СЧИТАЕМ, а не пишем словом. Стояло «Шесть программ курса», а
     проектов давно одиннадцать: заголовок отстал от данных и врал родителю на
     той самой странице, которая должна доказывать, что продукт настоящий.
     Найдено ревизией 18.09.2026. Число без сверки с данными — не число. */
  h += '<div class="card"><h3>🧱 ' + list.length + ' ' +
    A.plural(list.length, "программа", "программы", "программ") + ' курса</h3>' +
