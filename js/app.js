...
var LAND_ROLES = [
  ...
  { em:"🛠", tab:"Администратору", how:"вход по тому же паролю, что и у наставника",
...
/* Плитки кабинета. Одна разметка на вывеску и на сам кабинет (.lkgrid,
   ...
   продукт отказывается внутри (в панели наставника имён детей нет). */
...
function roomNavHTML(cur){
  /* ⚠️ Только на устройстве-кабинете. «Панель наставника» открывается по
...
function screenAbout(){
  ...
  h += '<section class="landend rv"><div class="lhaur" aria-hidden="true"></div>' +
    '<div class="endin"><div class="endleft">' +
      ...
      '<li><b>Экзамены не целиком.</b> Берём то, что решается программой. ' +
        'Электронные таблицы не проверить.</li>' +
      '<li><b>Проверяет программа.</b> Живого учителя и оценок тут нет.</li>' +
      '<li><b>Прогресс лежит в браузере.</b> Чтобы видеть его со второго устройства, ' +
        'нужен код ученика.</li>' +
      '</ul></div>' +
