...
function screenAbout(){
  ...
  h += '<div class="landsect rv">' +
    secHead("Весь сайт", "Подробнее — на сайте Фионики",
      "Кому это подходит, чего нет у других и сколько стоит: отдельными страницами.") +
    '<p class="landlede">На сайте разобрано то, что здесь не помещается: ' +
    'три двери (репетитору, семейное обучение, индивидуальный проект), ' +
    'чем это отличается от соседей и где проходят границы.</p>' +
