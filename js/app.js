...
/* ⚠️ Пример РИСУЕТ, а не печатает. Так было не всегда: до 1.94.0 здесь
   ...
   писавший кода, не связывает цифру в подписи с цифрой в программе. Стрелка
   стоит на той же строке, на том же расстоянии от глаза — и заодно
   показывает, что такое комментарий, ничего про него не рассказывая. */
var LAND_DEMO_OK =
