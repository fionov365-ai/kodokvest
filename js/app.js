...
function streakCurrent(){ return streakCurrentIn(S.days); }
function streakBest(){ return streakBestIn(S.days); }
...
function statsGridHTML(st){
  ...
  return '<div class="admstats">' +
    ...
    statBox("Дней подряд", streakCurrentIn(st.days) + " (рекорд " + streakBestIn(st.days) + ")") +
