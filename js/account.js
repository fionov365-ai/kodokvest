...
function screenAccount(){
  ...
  document.getElementById("logout").onclick = function(){
    /* ⚠️ По умолчанию НЕТ, а не ДА. Выход стирает прогресс и код ученика —
       единственное необратимое действие во всём продукте. Стояло `= true`, и
       там, где диалоги запрещены (страница во фрейме с sandbox), confirm
       бросал исключение, catch его глотал, и прогресс стирался вообще без
       вопроса. Не спросили — значит не разрешили. Найдено ревизией 18.09.2026. */
    var yes = false;
