...
function screenAlgo(){
  ...
  h += '<div class="card"><h3>⚖️ Что мы обещаем, а что нет</h3><ul class="trrules">' +
    ...
    '<li><b>Типы ЕГЭ — свои формулировки по духу экзамена.</b> Мы берём только те типы, ' +
    'где надо написать программу; кодирование информации и задания с файлами — не наши. ' +
...
function screenAbout(){
  ...
  h += '<section class="landend rv"><div class="lhaur" aria-hidden="true"></div>' +
    '<div class="endin"><div class="endleft">' +
      ...
      '<li><b>Экзамены закрываем не целиком.</b> Берём ту часть ОГЭ и ЕГЭ, где надо написать ' +
        'программу, и алгоритмику. Кодирование информации, таблицы и файлы сюда не входят.</li>' +
...
function landHowRender(i){
  ...
  box.innerHTML =
    ...
    '<div class="landcard dir" style="' + landWorldVars(3) + '">' +
      ...
      '<b>' + c.oge + '</b> в формате ОГЭ и <b>' + c.ege + '</b> в формате ЕГЭ. Плюс то, чего ' +
      'нет нигде: цену алгоритма тут не рассказывают, а считают шагами — «837 шагов против 11» ' +
      'видно числом на экране.</p></div>' +
    ...
    'Мы закрываем ту часть ОГЭ и ЕГЭ, где надо написать программу, и алгоритмику. ' +
    'Кодирование информации, таблицы и работа с файлами сюда не входят. Номера заданий ' +
    'не называем: нумерация между годами меняется.</div>';
}
...
function kidRender(savedNote){
  ...
  h += hwGiveHTML(st);
  if (!kidTarget.fresh){
    h += parentReportCardHTML() + askCardHTML(st);
